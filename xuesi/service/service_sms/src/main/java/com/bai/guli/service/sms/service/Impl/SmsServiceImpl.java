package com.bai.guli.service.sms.service.Impl;
...
import com.bai.guli.service.sms.utils.SmsProperties;
...
public class SmsServiceImpl implements SmsService {
    ...
    public void send(String mobile, String checkCode) throws ClientException {
        ...
        if ("isv.BUSINESS_LIMIT_CONTROL".equals(code)) {
            ...
            throw new CollegeException(ResultCode.SMS_SEND_ERROR_BUSINESS_LIMIT_CONTROL);
        }

        if (!"OK".equals(code)) {
            log.error("短信发送失败 " + " - code: " + code + ", message: " + message);
            throw new CollegeException(ResultCode.SMS_SEND_ERROR);  //短信发送失败
        }
    }
}
