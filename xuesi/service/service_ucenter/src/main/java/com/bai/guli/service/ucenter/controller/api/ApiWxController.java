...
import com.bai.guli.common.base.util.HttpClientUtils;
...
import com.bai.guli.service.ucenter.utils.UcenterProperties;
...
public class ApiWxController {
    ...
    public String genQrConnect(HttpSession session) {
        ...
        try {
            ...
            throw new CollegeException(ResultCode.URL_ENCODE_ERROR);
        }
    ...
    public String callback(String code, String state, HttpSession session) {
        ...
        if (StringUtils.isEmpty(code) || StringUtils.isEmpty(state)) {
            log.error("非法回调请求");
            throw new CollegeException(ResultCode.ILLEGAL_CALLBACK_REQUEST_ERROR);
        }
        ...
        try {
            ...
            throw new CollegeException(ResultCode.FETCH_ACCESSTOKEN_FAILD);
        }
