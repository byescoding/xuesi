...
export default {
  ...
  data() {
    ...
    this.getNestedChapterList()
  },
  methods: {

    // 获取嵌套的列表
    getNestedChapterList() {
    ...
    removeChapterById(chapterId) {
      this.$refs.chapterForm.removeChapterById(chapterId)
    },
    // 添加课时
    addVideo(chapterId) {
    ...
    removeVideoById(videoId) {
      this.$refs.videoForm.removeVideoById(videoId)
    },
    // 删除章节信息
    remidoveChapterById(videoId) {
